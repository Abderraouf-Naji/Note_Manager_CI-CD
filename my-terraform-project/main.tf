terraform {
  ...
  backend "s3" {
    bucket         = "custom-terraform-state-bucket-123456-0a90a558" # Replace with your S3 bucket name
...
resource "aws_s3_object" "private_key_object" {
  bucket                  = "custom-terraform-state-bucket-123456-0a90a558"  # Reference existing S3 bucket
